...
/*
 *  See
 * https://github.com/riscv-non-isa/riscv-sbi-doc/blob/master/riscv-sbi.adoc I
 * rewrite it all according to this document
 */
struct sbiret {
    long error;
    long value;
...
#ifdef _SBI_LEGANCY_
    /*
        * For the v0.1 version SBI,
            some funcitons are defined with different ext
        * id
        */
...
/*FID #0*/
struct sbiret sbi_debug_console_write(unsigned long num_bytes, unsigned long base_addr_lo,
                                      unsigned long base_addr_hi);
/*FID #1*/
struct sbiret sbi_debug_console_read(unsigned long num_bytes, unsigned long base_addr_lo,
                                     unsigned long base_addr_hi);
/*FID #2*/
...
/*FID #3*/
struct sbiret sbi_hart_suspend(u_int32_t suspend_type, unsigned long resume_addr,
...
/*FID #1*/
struct sbiret sbi_nacl_set_shmem(unsigned long shmem_phys_lo, unsigned long shmem_phys_hi,
                                 unsigned long flags);
/*FID #2*/
...
/*FID #0*/
struct sbiret sbi_steal_time_set_shmem(unsigned long shmem_phys_lo, unsigned long shmem_phys_hi,
                                       unsigned long flags);
/*
...
/*FID #0*/
struct sbiret sbi_system_suspend(u_int32_t sleep_type, unsigned long resume_addr,
                                 unsigned long opaque);
