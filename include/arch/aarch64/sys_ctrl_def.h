...
/* ASIDBits, bits [7:4]: 0b0000 => 8-bit ASID, 0b0010 => 16-bit ASID */
#define ID_AA64MMFR0_EL1_ASIDBITS_SHIFT (4)
#define ID_AA64MMFR0_EL1_ASIDBITS_WIDTH (4)
#define ID_AA64MMFR0_EL1_ASIDBITS_MASK \
        (0xFULL << ID_AA64MMFR0_EL1_ASIDBITS_SHIFT)
#define ID_AA64MMFR0_EL1_ASIDBITS_8BIT  (0)
#define ID_AA64MMFR0_EL1_ASIDBITS_16BIT (2)
#define ID_AA64MMFR0_EL1_GET_ASIDBITS(mmfr0)        \
        (((mmfr0) & ID_AA64MMFR0_EL1_ASIDBITS_MASK) \
