...
#define _8259A_ICW_1_SNGL_                                                     \
	(1 << 1) /*D1, 1 means single 8259A,0 means multipul*/
#define _8259A_ICW_1_LTIM_                                                     \
	(1 << 3) /*D3, 1 means level trigged,0 means edge-trigged*/
...
#define _8259A_ICW_4_MS_                                                       \
	(1 << 2) /*Under Buffering Method, 1 means use master, 0 means slave*/
...
#define _8259A_OCW_2_R_                                                        \
	(1 << 7) /*for priority, and use sl and L2-L0 to indicate the priority*/
...
#define _8259A_OCW_3_RIS_                                                      \
	(1 << 0) /*set RR, if RIS=0, read IRR, RIS=1, read ISR*/
#define _8259A_OCW_3_RR_ (1 << 1) /*indicate the validation of read*/
#define _8259A_OCW_3_P_ (1 << 2)  /*indicate polling*/

#define _8259A_OCW_3_D3_                                                       \
	(1 << 3) /*must be 1 to indicate it's OCW 3 (and D4 must be 0)*/
#define _8259A_OCW_3_SMM_                                                      \
