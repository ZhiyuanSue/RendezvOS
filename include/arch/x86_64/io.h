...
static inline void		outb(u_int16_t port,
							u_int8_t data) __attribute__((always_inline));
static inline void		outw(u_int16_t port,
							u_int16_t data) __attribute__((always_inline));
static inline void		outl(u_int16_t port,
							u_int32_t data) __attribute__((always_inline));
