...
#define	PML4E_A	(1<<5)
#define	PML4E_PS	(1<<7)
#define	PML4E_G	(1<<8)	/*1G huge page only*/
#define	PML4E_ADDR(addr,m)	(((addr<<12)>>12) & MAXPHYADDR_mask(m))
#define	PML4E_PAT	(1<<12)	/*1G huge page only*/
#define	PML4E_ADDR_1G(addr,m)	(((addr<<30)>>30) &MAXPHYADDR_mask(m))	/*1G huge page only*/
#define	PML4E_PKE(prot_key)	((prot_key & 0xf)<<59)	/*1G huge page only*/
#define	PML4E_XD	(1<<63)
...
#define	PDPTE_A	(1<<5)
#define	PDPTE_PS	(1<<7)
#define	PDPTE_G	(1<<8)	/*2m huge page only*/
#define	PDPTE_ADDR(addr,m)	(((addr<<12)>>12) & MAXPHYADDR_mask(m))
#define	PDPTE_PAT	(1<<12)	/*2m huge page only*/
#define	PDPTE_ADDR_1G(addr,m)	(((addr<<21)>>21) &MAXPHYADDR_mask(m))	/*2m huge page only*/
#define	PDPTE_PKE(prot_key)	((prot_key & 0xf)<<59)	/*2m huge page only*/
