...
static void RB_Remove(struct rb_node* rb_p, struct rb_root* root);
static struct rb_node* RB_Prev(struct rb_node* rb_p);
static struct rb_node* RB_Next(struct rb_node* rb_p);
...
static void RB_SolveDoubleRed(struct rb_node* rb_p, struct rb_root* root);

/*implement*/
static inline u64 update_height(struct rb_node* rb_p)
{
        rb_p->black_height =
...
rb_removeAt(struct rb_node* rb_p, struct rb_root* root, struct rb_node** _hot)
{
...
static inline struct rb_node* connect34(struct rb_node* a, struct rb_node* b,
...
static inline struct rb_node* rotateAt(struct rb_node* v)
{
...
static inline void RB_SolveDoubleBlack(struct rb_node* rb_p,
                                       struct rb_root* root,
                                       struct rb_node* _hot)
{
...
static inline struct rb_node* RB_Prev(struct rb_node* rb_p)
{
        if (!rb_p)
                return NULL;
...
static inline struct rb_node* RB_Next(struct rb_node* rb_p)
{
        if (!rb_p)
                return NULL;
...
static inline void RB_Remove(struct rb_node* rb_p, struct rb_root* root)
{
...
static inline void RB_SolveDoubleRed(struct rb_node* rb_p, struct rb_root* root)
{
        if (RB_ISROOT(rb_p)) {
                RB_SET_BLACK(rb_p);
                rb_p->black_height++;
