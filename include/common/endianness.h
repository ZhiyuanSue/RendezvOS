...
static inline uint64_t SWAP_ENDIANNESS_64(uint64_t uint_64) {
    return ((uint_64 & 0x00000000000000ff) << 56) + ((uint_64 & 0x000000000000ff00) << 40) +
           ((uint_64 & 0x0000000000ff0000) << 24) + ((uint_64 & 0x00000000ff000000) << 8) +
           ((uint_64 & 0x000000ff00000000) >> 8) + ((uint_64 & 0x0000ff0000000000) >> 24) +
           ((uint_64 & 0x00ff00000000ff00) >> 40) + ((uint_64 & 0xff00000000000000) >> 56);
}
