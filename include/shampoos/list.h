...
static inline void __list_add(struct list_entry *new_node, struct list_entry *prev,
...
static inline void list_add_head(struct list_entry *new_node, struct list_entry *head) {
...
static inline void list_replace(struct list_entry *old_node, struct list_entry *new_node) {
    new_node->next       = old_node->next;
    new_node->next->prev = new_node;
    new_node->prev       = old_node->prev;
    new_node->prev->next = new_node;
}
static inline void list_replace_init(struct list_entry *old_node, struct list_entry *new_node) {
