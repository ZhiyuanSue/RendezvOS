...
//                 return NULL;
//         }
//         VSpace* vs = per_cpu(current_vspace, handler->cpu_id);
//         /*get a phy page*/
...
//                 VSpace* vs = nexus_node_vspace(vspace_root_node);
...
//  * failure. */
// static error_t _vspace_clone_cow(VSpace* dst_vs,
//                                  struct nexus_node* dst_nexus_node,
//                                  VSpace* src_vs, vaddr va,
...
//         VSpace* vs, struct map_handler* handler, struct pmm* pmm_ptr,
...
//  */
// static error_t _vspace_update_user_leaf_flags(VSpace* vs,
//                                               struct nexus_node* vspace_node,
...
//         VSpace* vs = nexus_node_vspace(nexus_root);
...
//         VSpace* vs = vspace_node->vs_common;
...
// error_t nexus_update_range_flags(struct nexus_node* nexus_root, VSpace* vs,
...
// error_t nexus_remap_user_leaf(VSpace* vs, vaddr va, ppn_t new_ppn,
