...
void init_map()
{
        ...
        arch_set_L0_entry(
                KERNEL_VIRT_TO_PHY(MAP_L1_table), map_pages, L0_table, 0);
        arch_set_L1_entry(
                KERNEL_VIRT_TO_PHY(MAP_L2_table), map_pages, &MAP_L1_table, 0);
        arch_set_L2_entry(
                KERNEL_VIRT_TO_PHY(MAP_L2_table), map_pages, &MAP_L2_table, 0);
        // TODO:flush tlb
}
