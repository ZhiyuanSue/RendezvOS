...
void	print_property_value_stringlist(enum property_type_enum p_type,
		void *data, uint32_t len)
{
...
void						(*print_property_value_list[7])(enum property_type_enum p_type,
								void *data,
								uint32_t len) = {print_property_value_empty,
							print_property_value_u32, print_property_value_u64,
...
void	print_property_value(const char *property_name, void *data,
		uint32_t len)
{
